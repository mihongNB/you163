...
if (isset($_POST['submit']) && $_POST['submit'] == "注册") {
	...
	$email = $_POST['email'];
		//添加语句
	$query = "insert loginreg(id,username,email,password,data) values(null,'$user','$email','$pass',NOW())";
	mysql_query($query);
	header('location:http://10.31.162.113/skz/you163/src/login.html');//页面的跳转
}
?>